...
describe('Misc', function () {
  ...
  it('Should render link target attr', function () {
    const md = markdownit().use(forInline, 'target', 'link_open', function (tokens, idx) {
  ...
  it('Should normalize CR to LF', function () {
    ...
    assert.strictEqual(md.render('# test\r\r - hello\r - world\r'), md.render('# test\n\n - hello\n - world\n'));
  });
...
describe('maxNesting', function () {
  ...
  it('Inline nesting coverage', function () {
    const md = markdownit({ maxNesting: 2 });
    assert.strictEqual(md.render('[[[[[[[[[[[[[[[[[[foo]()'), '<p>[[[[[[[[[[[[[[[[[[foo]()</p>\n');
  });
});
...
describe('smartquotes', function () {
  ...
  it('Should support nested multi-character quotes', function () {
    assert.strictEqual(md.render('"foo \'bar\' baz"'), '<p>[[[foo (((((bar)))) baz]]</p>\n');
  });

  it('Should support multi-character quotes in different tags', function () {
    assert.strictEqual(md.render('"a *b \'c *d* e\' f* g"'), '<p>[[[a <em>b (((((c <em>d</em> e)))) f</em> g]]</p>\n');
  });
});
...
describe('Token attributes', function () {
  it('.attrJoin', function () {
    ...
    assert.strictEqual(md.renderer.render(tokens, md.options), '<pre><code class="foo bar"></code></pre>\n');
  });
  ...
  it('.attrSet', function () {
    ...
    assert.strictEqual(md.renderer.render(tokens, md.options), '<pre><code class="foo"></code></pre>\n');

    t.attrSet('class', 'bar');

    assert.strictEqual(md.renderer.render(tokens, md.options), '<pre><code class="bar"></code></pre>\n');
  });
